...
public interface AdvancedSlimePaperAPI {
    ...
    @ApiStatus.Internal
    class Holder {
        private static final AdvancedSlimePaperAPI INSTANCE = Services.service(AdvancedSlimePaperAPI.class).orElseThrow(() -> new NoSuchElementException("No value present"));
    }
}
